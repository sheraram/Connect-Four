...
let firstPlayer = prompt('Enter the First player name (Green Ball)');
if (firstPlayer === '' || firstPlayer === null) {
  firstPlayer = 'Green';
}

let secondPlayer = prompt('Enter the Second player name (Red Ball)');
...
const checkWinningCells = (cells) => {
  ...
  gameIsLive = false;
  for (const cell of cells) cell.classList.add('win');
...
const handleCellMouseOver = (e) => {
  ...
  if (greenIsNext) topCell.classList.add('green');
  else topCell.classList.add('red');
};
